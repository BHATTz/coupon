...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="admin-assets/images/logo.svg" width="48" height="48" alt="Alpino">
        </div>
        <p>Please wait...</p>
    </div>
</div>
...
<aside id="minileftbar" class="minileftbar">
    <ul class="menu_list">
        <li>
            ...
            <a class="navbar-brand" href="index.html"><img src="admin-assets/images/logo.svg" alt="Alpino"></a>
        </li>
        <li><a href="javascript:void(0);" class="btn_overlay hidden-sm-down"><i class="zmdi zmdi-search"></i></a>
        </li>
        <li><a href="javascript:void(0);" class="menu-sm"><i class="zmdi zmdi-swap"></i></a></li>
        <li class="menuapp-btn"><a href="javascript:void(0);"><i class="zmdi zmdi-ticket-star"></i></a></li>
        <li class="categoryapp-btn"><a href="javascript:void(0);"><i class="zmdi zmdi-label-alt"></i></a></li>
        <li class="storeapp-btn"><a href="javascript:void(0);"><i class="zmdi zmdi-label-alt"></i></a></li>
        <li class="brandapp-btn"><a href="javascript:void(0);"><i class="zmdi zmdi-label-alt"></i></a></li>
...
<aside class="right_menu">
    <div class="menu-app">
        <div class="slim_scroll">
            <div class="card">
                <div class="header">
                    <h2><strong>Coupon</strong> Menu</h2>
                </div>
                <div class="body">
                    <ul class="list-unstyled menu">
                        <li><a href="{{ route('admin.coupon.create') }}"><span>Create Coupon</span></a></li>
                        <li><a href="{{ route('admin.coupon.dailyCreateForm')}}"><span>Daily CouponCode</span></a></li>
                        <li><a href="{{ route('admin.coupon.dailyWinner')}}"><span>Daily Winner</span></a></li>
                        <li><a href="{{ route('admin.coupon.view') }}"><span>View All</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="category-app">
    <div class="slim_scroll">
        <div class="card">
            <div class="header">
                <h2><strong>Category</strong> Menu</h2>
            </div>
            <div class="body">
                <ul class="list-unstyled menu">
                    <li><a href="{{ route('admin.category') }}"><span>Create Category</span></a></li>
                    </li>
                    <li><a href="{{ route('admin.category-list') }}"><span>View Category</span></a>
                    </li>
            </div>
        </div>
    </div>
...
<div class="store-app">
    <div class="slim_scroll">
        <div class="card">
            <div class="header">
                <h2><strong>Store</strong> Menu</h2>
            </div>
            <div class="body">
                <ul class="list-unstyled menu">
                    <li><a href="{{ route('admin.stores') }}"><span>Create Store</span></a></li>
                    </li>
                    <li><a href="{{ route('admin.stores-list') }}"><span>View Store</span></a>
                    </li>
            </div>
        </div>
    </div>
...
<div class="brand-app">
    <div class="slim_scroll">
        <div class="card">
            <div class="header">
                <h2><strong>brand</strong> Menu</h2>
            </div>
            <div class="body">
                <ul class="list-unstyled menu">
                    <li><a href="{{ route('admin.brands') }}"><span>Create brand</span></a></li>
                    </li>
                    <li><a href="{{ route('admin.brands-list') }}"><span>View brand</span></a>
                    </li>
            </div>
        </div>
    </div>
                ...
                <div class="body">
                    <ul class="messages list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="admin-assets/images/xs/avatar1.jpg"
                                        alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="admin-assets/images/xs/avatar2.jpg"
                                        alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="admin-assets/images/xs/avatar3.jpg"
                                        alt="">
                                    <div class="media-body">
